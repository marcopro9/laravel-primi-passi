...
<main class="container">
  ...
  <p>
    ...
    20146 Milano rappresentata da Fabio Forghieri e Roberto Marazzini n qualità
    di Titolari del trattamento dei dati personali, La informa che i Suoi dati
    verranno trattati nel rispetto dei principi di correttezza, liceità e trasparenza
  ...
  <p>
    ...
    venduti sul presente Sito.<br>
    I dati personali raccolti sono: Nome, Cognome, Data di Nascita, Numero
    di Telefono, Indirizzo di Residenza o di esercitazione della professione,
    Username, Email, Password, Ragione sociale, Codice Fiscale, Partita IVA e
    Professione, l’indirizzo IP ed altri dati riferibili alle generalità dell’
    Utente o alle modalità tecniche di accesso dell’Utente al Sito.<br>
    Altri dati raccolti per il completamento del profilo di ogni utente (denominato
     “Studente”) riguardano la propria professionalità ed includono, a titolo
     esemplificativo: titolo di studio, età, anni di esperienza lavorativa e
     informazioni curriculari.<br>
    I dati di navigazione utili per l’utilizzo tecnico del Sito sono raccolti
    necessariamente e il loro conferimento non è facoltativo.<br>
    Il mancato trattamento di alcuni dati (es. i dati di contatto, o gli indirizzi,
     o dati sul comportamento o sulle preferenze dell’utente ecc.) potrebbe rendere
     impossibile la prestazione dei servizi da parte del Sito. Se l’Utente utilizza
     il Sito per pubblicare o comunque condividere dati personali di terzi,
     (Interessati diversi dall’Utente) ne assume le relative responsabilità.
     In tal senso, l’Utente garantisce di avere il diritto di comunicare o diffondere
     i dati personali dei terzi e di averli previamente informati del trattamento,
     sollevando il Sito da ogni responsabilità per il loro trattamento strumentale
     in seguito alla loro comunicazione o diffusione.
  </p>
  ...
  <ul class="indented_list">
    ...
    <li>
      l’aggiornamento dell’Utente sui nuovi prodotti o servizi erogati dal
      Sito o in relazione a particolari offerte commerciali;
    </li>
    <li>
      l’informazione dell’Utente in occasione di manutenzione sul Sito o di
    ...
    <li>
      la visualizzazione di banner pubblicitari in relazione agli interessi
      dell’Utente (behavioral targeting/advertising);
    </li>
    <li>
      la difesa da parte del Titolare del Sito, in giudizio o nelle fasi
      propedeutiche alla sua eventuale instaurazione, da abusi nell’utilizzo
      dello stesso o dei servizi connessi da parte dell’Utente.
    </li>
  </ul>
  ...
  <ul class="indented_list">
    ...
    dell’art. 6 lett. a) del GDPR (ad esempio nel caso di invio di comunicazioni
    promozionali, profilazione commerciale, behavioral advertising,
    geolocalizzazione ecc.);
    </li>
    <li>
      il trattamento è necessario all'esecuzione di un contratto con l’Utente
      e/o all'esecuzione di misure precontrattuali ai sensi dell’art. 6 lett. b)
      del GDPR;
    </li>
    <li>
      il trattamento è necessario per adempiere un obbligo legale al quale è
      soggetto il Titolare ai sensi dell’art. 6 lett. c) del GDPR;
    </li>
    <li>
  ...
  <p>
    ...
    base giuridica di ciascun trattamento ed in particolare di specificare se il
  ...
  <p>
    ...
    della riservatezza e dei diritti. Possono essere utilizzate, inoltre, altre
    modalità (audio, video, ecc.) ritenute utili caso per caso.
    I dati sono inoltre protetti mediante misure tecniche ed organizzative per
    assicurare idonei livelli di sicurezza e riservatezza ai sensi degli artt.
    25 e 32 del GDPR.
  </p>
  ...
  <ul class="indented_list">
    <li>
      Direct Email Marketing (DEM): questo Sito può utilizzare i Dati dell’Utente,
      se dallo stesso previamente autorizzato, per inviare proposte di natura
      commerciale in relazione a servizi e prodotti forniti da terze parti.
      In caso di promozione di prodotti o servizi del titolare analoghi a quelli
      venduti all’interessato non è necessario il consenso, ma l’interessato, può
      opporsi in ogni momento a nuovi invii. I dati personali raccolti sono:
      Email, Cookie, Indirizzo IP, Nome e Cognome.
    </li>
    <li>
      Soggetti che forniscono servizi di pubblicità consentendo al Sito di utilizzare
      i Dati dell’Utente per finalità di comunicazione commerciale visualizzate sotto
      forma di banner e altre forme pubblicitarie sul Sito in relazione agli interessi
      dell’Utente;
    </li>
    <li>
      Soggetti che forniscono servizi di statistica che tengono traccia del
      comportamento dell’Utente ed, in caso di profilazione, possono richiedere
      il consenso espresso dell’Utente (Google Analytics, Social Plugin, Google + …).
    </li>
  </ul>
  ...
  <ul class="indented_list">
    <li>
      Chrome: <a href="#">Link</a>
    </li>
    <li>
      Firefox: <a href="#">Link</a>
    </li>
    <li>
      Internet Explorer: <a href="#">Link</a>
    </li>
    <li>
      Opera: <a href="#">Link</a>
    </li>
